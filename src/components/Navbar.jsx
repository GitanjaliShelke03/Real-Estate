...
const Navbar = () => {
  ...
  return (
    <div className="absolute --0 left-0 w-full z-10">
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent' >
        <img src={assets.logo} alt="" />
        <ul className='hidden md:flex gap-7 text-w' >
      ...
      {/*--------mobile-menu-----*/}
      <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : "h-0 w-0"} right-0 top-0 bottom-0 overflow-hidden bg-white transition-all ${showMobileMenu ? 'translate-x-0' : 'translate-x-full'}`}>
